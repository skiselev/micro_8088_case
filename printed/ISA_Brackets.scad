...
module eth_bracket() {
    ...
    translate([cut_left_height+cut_left_width,0,0]) {
        rotate([0,0,270]) {
            rounded_cube_z2(3.5,pcb_mount_2_x+12.065-cut_left_height-cut_left_width,pcb_mount_thick,1);
        }
    }
    // top reinforcement
...
module blank_bracket() {
        ...
        difference() {
            union() {
                ...
                translate([-br_thick,0,cut_left_width]) {
                    ...
                    rotate([90,0,90]) {
                        rounded_cube_z2(tab_length+br_thick,tab_width,br_thick,2);
                    }
    ...
    translate([br_height_wo_tongue,br_thick,tongue_cut_width]) {
        ...
        rotate([90,0,0]) {
            rounded_cube_z2(tongue_height,tongue_width,br_thick,2);
        }
    }
}
...
module pcb_mount() {
    difference () {
        translate([-pcb_mount_width/2,0,0]) {
            rotate([0,0,270]) {
                rounded_cube_z2(pcb_mount_length,pcb_mount_width,1,pcb_mount_thick);
            }
        }
